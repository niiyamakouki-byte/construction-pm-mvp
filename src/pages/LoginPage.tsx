      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-brand-200 bg-white p-8 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-600 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-brand-700"
          >
          ...
          <div className="my-5 flex items-center gap-3">
            ...
            <span className="text-xs text-slate-400">他の方法</span>
            <hr className="flex-1 border-slate-200" />
          </div>
          ...
          {!showMagicLink ? (
            <button
              ...
              className="mt-3 w-full rounded-lg px-4 py-2 text-xs font-medium text-slate-500 hover:text-slate-700 hover:underline"
            >
              マジックリンクでログイン
            </button>
          ) : (
