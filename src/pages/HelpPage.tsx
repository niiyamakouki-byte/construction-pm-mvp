...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    question: "業者を登録する方法は？",
    answer:
      "下のナビ（またはデスクトップは上のナビ）から「業者」タブを開きます。「業者を登録」ボタンから会社名・担当者名・電話番号・メールアドレスを入力して登録できます。登録後は工程表のタスクに担当業者として割り当てられます。",
    icon: "🏢",
  },
  {
    id: "change-duration",
  ...
  },
  {
    ...
    answer:
      "案件作成時に現場住所を入力しておくと、案件詳細ページで現場周辺の天気予報が表示されます。雨天の日は作業に影響するため、前日に確認することをおすすめします。",
    icon: "🌤️",
  },
  {
    id: "project-status",
    question: "案件のステータスを変更するには？",
    answer:
      "「案件」タブから案件一覧を表示し、変更したい案件をタップします。案件詳細ページの「ステータス」欄から「計画中」「進行中」「完了」「保留」を選択できます。",
    icon: "🔄",
  },
  {
    id: "multiple-projects",
    question: "複数の案件を同時に管理できますか？",
    answer:
      "はい、案件数に制限はありません。「案件」タブから複数の案件を登録・管理できます。工程表では全案件のタスクが一覧表示されるため、現場をまたいだ日程の調整もできます。",
    icon: "📁",
  },
  {
    id: "notifications",
